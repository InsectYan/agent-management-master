 ...
 * @description 小说结构化生成（Loop 单步 JSON）：基础信息、世界观与人物。
 */
...
module.exports = {
  ...
  version: '0.1.0',
  description: '小说结构化生成：基础信息、世界观与人物 patch',
  scheme: 'loop',
  routes: [
    {
      path: '/api/skills/novel-writer',
      method: 'POST',
      description: 'fill_basic / fill_world / fill_characters / rewrite_field',
      requiresAuth: false,
    },
  ],
  dbTables: [],
  ...
  config: {
    ...
    loop: {
      ...
      jsonSchemaHint: [
        ...
        '  "patch": { "characters": [{ "name": "姓名", "role": "main" }], "character_edges": [{ "source": "甲", "target": "乙", "relation": "enemy" }] }',
        '}',
      ].join('\n'),
      userContextFields: [
        'scene',
